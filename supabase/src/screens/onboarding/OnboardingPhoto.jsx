...
export default function OnboardingPhoto() {
  ...
  return (
    <div className="onboarding-page onboarding-page--center">
      <h1 className="onboarding-title">Ajoute ta meilleure photo</h1>
      <p className="onboarding-sub">Les profils avec photo ont 10x plus de matchs</p>
      <button
        type="button"
      ...
      >
        {preview ? (
          ...
          <>
            ...
            <span className="photo-label">Ajouter une photo</span>
          </>
        )}
      </button>
      <input
