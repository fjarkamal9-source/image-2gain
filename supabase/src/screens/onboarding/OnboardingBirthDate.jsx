...
export default function OnboardingBirthDate() {
  ...
  return (
    <div className="onboarding-page">
      <h1 className="onboarding-title" style={{ color: '#111111', fontWeight: '900' }}>Quelle est ta date de naissance ?</h1>
      <p className="onboarding-sub" style={{ color: '#111111', fontWeight: '700' }}>Tu dois avoir au moins 18 ans</p>
